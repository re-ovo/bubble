...
function trackObject<T extends object>(value: T, versionObject: Tracked<any>): Tracked<T> {
...
function trackMap<K, V extends object>(map: Map<K, V>, versionObject: Tracked<any>): Tracked<Map<K, V>> {
